export default [
	...
	{
		title: "Transcendence",
		description: "Jeu PONG revisité, en permettant de défier d'autres utilisateurs connectés à l'application.",
	...
	{
		title: "Inception",
		description: "Mise en place d'une mini-infrastructure de services orchestrés par docker-compose.",
